...
deepspeed --include localhost:0,1 --master_port=29503 llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /leonardo_scratch/large/userexternal/fgaragna/dataset/viral/llava_v1_5_mix665k.json \
    --image_folder /leonardo_scratch/large/userexternal/fgaragna/dataset/viral \
    ...
    --bf16 True \
    --output_dir /leonardo_scratch/large/userexternal/fgaragna/checkpoints/viral \
    --num_train_epochs 1 \
